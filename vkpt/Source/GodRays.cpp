...
vkpt::GodRays::GodRays(VkDevice _device, std::shared_ptr<MemoryAllocator> &_allocator,
...
void vkpt::GodRays::CreateDescriptors()
{
    VkResult r;
...
void vkpt::GodRays::CreatePipelines(const ShaderManager *shaderManager)
{
    VkResult r;
...
void vkpt::GodRays::DestroyPipelines()
{
    if (tracePipeline)
    {
...
void vkpt::GodRays::OnShaderReload(const ShaderManager *shaderManager)
{
    DestroyPipelines();
    CreatePipelines(shaderManager);
}

void vkpt::GodRays::Trace(VkCommandBuffer cmd, uint32_t frameIndex, const Params &params, uint32_t passIndex)
{
...
void vkpt::GodRays::Filter(VkCommandBuffer cmd, uint32_t frameIndex)
{
